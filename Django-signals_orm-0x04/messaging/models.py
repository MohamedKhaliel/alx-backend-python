...
class MessageHistory(models.Model):
    ...
    edited_at = models.DateTimeField(auto_now_add=True)  # required field
    edited_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True)  # required field
